        ...
        >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 relative z-10">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-red-600 to-rose-600 text-white font-sans text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                    <Sparkles className="w-3 h-3" />
                    AMD Radeon Official Specification
                  </span>
                  <span className="bg-red-950/80 border border-red-500/40 text-red-300 font-sans text-[11px] font-bold px-2.5 py-0.5 rounded-full">
                    {radeon.architecture}
                  </span>
                ...
                <div className="flex items-center gap-3 text-xs font-sans text-red-400 mt-1">
          ...
          <div className="p-6 sm:p-8 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-neutral-900/90 border border-red-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">Compute Units</div>
                  <div className="text-2xl sm:text-3xl font-black text-red-400 font-sans">
                    {radeon.computeUnits}
                  </div>
                ...
                <div className="bg-neutral-900/90 border border-rose-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">Stream Processors</div>
                  <div className="text-2xl sm:text-3xl font-black text-rose-300 font-sans">
                ...
                <div className="bg-neutral-900/90 border border-amber-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">Ray Accelerators</div>
                ...
                <div className="bg-neutral-900/90 border border-purple-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">AI Accelerators</div>
                  <div className="text-xl sm:text-2xl font-black text-purple-300 font-sans">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-neutral-900/70 border border-neutral-800 rounded-2xl p-4">
                  ...
                  <div className="text-lg font-bold text-white font-sans mt-1">{radeon.baseClock}</div>
                  <div className="text-[11px] text-neutral-400 mt-0.5">Sustained minimum frequency</div>
                </div>

                <div className="bg-neutral-900/70 border border-neutral-800 rounded-2xl p-4">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase">Game Clock</div>
                  <div className="text-lg font-bold text-emerald-300 font-sans mt-1">{radeon.gameClock}</div>
                ...
                <div className="bg-neutral-900/70 border border-red-500/30 rounded-2xl p-4 relative overflow-hidden">
                  ...
                  <div className="text-[10px] font-sans text-red-400 uppercase font-bold">Max Boost Clock</div>
                  <div className="text-xl font-black text-red-300 font-sans mt-1">{radeon.boostClock}</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-4">
                  ...
                  <div className="text-lg font-bold text-white font-sans mt-1">{radeon.vram}</div>
                </div>

                <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-4">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase">Memory Bus Width</div>
                  <div className="text-lg font-bold text-amber-300 font-sans mt-1">{radeon.memoryBusWidth}</div>
                </div>

                <div className="bg-neutral-900/80 border border-neutral-800 rounded-2xl p-4">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase">Memory Bandwidth</div>
                  <div className="text-lg font-bold text-cyan-300 font-sans mt-1">{radeon.memoryBandwidth}</div>
                </div>

                <div className="bg-neutral-900/80 border border-rose-500/30 rounded-2xl p-4">
                  <div className="text-[10px] font-sans text-rose-400 uppercase font-bold">Infinity Cache</div>
                  <div className="text-lg font-black text-rose-300 font-sans mt-1">{radeon.infinityCache}</div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-neutral-800">
                    ...
                    <span className="font-sans font-bold text-yellow-400 text-sm">{radeon.boardPowerTbp}</span>
                  </div>
                  <div className="flex items-center justify-between pb-2 border-b border-neutral-800">
                    <span className="text-xs text-neutral-400">PCIe Host Interface</span>
                    <span className="font-sans font-bold text-white text-sm">{radeon.pcieInterface}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-neutral-400">API Support Standards</span>
                    <span className="font-sans font-bold text-rose-300 text-xs">{radeon.apiSupport}</span>
                  </div>
                </div>
                ...
                <div className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-4 space-y-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-xs font-bold text-neutral-200">{radeon.displayOutputs}</span>
                    </div>
                  </div>
                  <div className="pt-2 border-t border-neutral-800">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-xs font-bold text-neutral-200">{radeon.mediaEngine}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-red-950/20 border border-red-500/30 rounded-2xl p-5 relative">
              <div className="flex items-center gap-2 text-xs font-sans text-red-400 font-bold uppercase tracking-wider mb-2">
