      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-red-950 via-neutral-900 to-amber-950 border-b border-orange-500/30 p-6 sm:p-8 overflow-hidden">
            ...
            <div className="absolute -bottom-10 -left-10 w-60 h-60 bg-[#FF1E2D]/10 rounded-full blur-2xl pointer-events-none" />
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 relative z-10">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-red-600 to-amber-600 text-white font-sans text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
                    <Sparkles className="w-3 h-3" />
                    AMD Ryzen Architecture
                  </span>
                  <span className="bg-orange-950/80 border border-orange-500/40 text-orange-300 font-sans text-[11px] font-bold px-2.5 py-0.5 rounded-full">
                    {ryzen.architecture}
                  </span>
                  ...
                  {isX3D && (
                    <span className="bg-rose-950 text-rose-300 font-sans text-[11px] font-bold px-2.5 py-0.5 rounded-full border border-rose-500/40">
                      AMD 3D V-Cache™
                    </span>
                  )}
                ...
                <div className="flex items-center gap-3 text-xs font-sans text-orange-400 mt-1">
                  <span>Codename:</span>
          ...
          <div className="p-6 sm:p-8 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            <div>
              <div className="flex items-center gap-2 text-xs font-sans text-orange-400 font-bold uppercase tracking-wider mb-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-neutral-900/90 border border-orange-500/20 rounded-2xl p-4 text-center">
                  ...
                  <div className="text-2xl sm:text-3xl font-black text-orange-400 font-sans">
                    {ryzen.totalCores}
                  </div>
                ...
                <div className="bg-neutral-900/90 border border-amber-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">Core Breakdown</div>
                  <div className="text-lg sm:text-xl font-bold text-amber-300 font-sans truncate">
                    {ryzen.coreBreakdown}
                  </div>
                ...
                <div className="bg-neutral-900/90 border border-red-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">Threads</div>
                ...
                <div className="bg-neutral-900/90 border border-purple-500/20 rounded-2xl p-4 text-center">
                  <div className="text-[10px] font-sans text-[#FF1E2D] font-bold uppercase mb-1">AI Engine / NPU</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-neutral-900/70 border border-neutral-800 rounded-2xl p-4">
                  ...
                  <div className="text-lg font-bold text-white font-sans mt-1">{ryzen.baseClock}</div>
                ...
                <div className="bg-neutral-900/70 border border-orange-500/30 rounded-2xl p-4 relative overflow-hidden">
                  ...
                  <div className="text-[10px] font-sans text-orange-400 uppercase font-bold">Max Boost Clock</div>
                  <div className="text-xl font-black text-orange-300 font-sans mt-1">{ryzen.boostClock}</div>
                ...
                <div className={`rounded-2xl p-4 border ${
                  ...
                  <div className="text-[10px] font-sans uppercase text-amber-400 font-bold">L3 Cache Pool</div>
                  <div className="text-lg font-bold font-sans mt-1 text-amber-300">{ryzen.l3Cache}</div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-4 space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-neutral-800">
                    ...
                    <span className="font-sans font-bold text-yellow-400 text-sm">{ryzen.tdp}</span>
                  </div>
                  <div className="flex items-center justify-between pb-2 border-b border-neutral-800">
                    <span className="text-xs text-neutral-400">Motherboard Socket</span>
                    <span className="font-sans font-bold text-orange-400 text-sm">{product.specs.socket || 'AM5'}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-neutral-400">Lithography / Process Node</span>
                    <span className="font-sans font-bold text-neutral-300 text-sm">{ryzen.processNode}</span>
                  </div>
                </div>
                ...
                <div className="bg-neutral-900/60 border border-neutral-800 rounded-2xl p-4 space-y-3">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-xs font-bold text-neutral-200">{ryzen.igpu}</span>
                    </div>
                  </div>
                  <div className="pt-2 border-t border-neutral-800">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-xs font-bold text-neutral-200">{ryzen.memorySupport}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-orange-950/20 border border-orange-500/30 rounded-2xl p-5 relative">
              <div className="flex items-center gap-2 text-xs font-sans text-orange-400 font-bold uppercase tracking-wider mb-2">
