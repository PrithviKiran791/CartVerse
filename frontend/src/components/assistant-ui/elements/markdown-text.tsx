...
const CodeHeader: FC<CodeHeaderProps> = ({ language, code }) => {
  ...
  return (
    <div className="aui-code-header-root border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-800/60 mt-3 flex items-center justify-between rounded-t-xl border border-b-0 px-3.5 py-1.5 text-xs">
      <span className="aui-code-header-language text-neutral-500 dark:text-neutral-400 font-medium lowercase">
        {language}
      </span>
      <button
        type="button"
        title="Copy code"
        onClick={onCopy}
        className="p-1 text-neutral-400 hover:text-neutral-900 dark:hover:text-white rounded hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors flex items-center gap-1 text-[10px] cursor-pointer"
      >
        {!isCopied ? (
