...
export function SignupFormDemo({ onSubmit, className }: SignupFormProps) {
  ...
  return (
    <div
      className={cn(
        "shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-neutral-200 dark:border-neutral-800/80 shadow-2xl",
        className
      )}
    >
