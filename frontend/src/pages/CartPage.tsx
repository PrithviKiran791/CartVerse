...
export const CartPage: React.FC = () => {
  ...
  if (items.length === 0 && bundles.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        ...
        <h2 className="text-2xl sm:text-3xl font-black text-white mb-2">Your Shopping Cart is Empty</h2>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-3xl font-black text-white tracking-tight mb-8">Shopping Cart ({totalItems})</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="bg-neutral-900/90 border border-neutral-800 rounded-3xl p-6 space-y-6 sticky top-28 backdrop-blur-md">
          <h3 className="text-base font-bold text-white uppercase tracking-wider pb-3 border-b border-neutral-800">
            Order Summary
          </h3>
