      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        <FadeContent blur={true} duration={800} easing="ease-out" initialOpacity={0}>
          <div className="border-b-2 border-neutral-800 pb-8 mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-none bg-cyan-950/60 border-2 border-cyan-500 text-cyan-400 text-xs font-mono font-bold uppercase tracking-widest mb-3 shadow-[2px_2px_0px_0px_#06B6D4]">
            ...
            <p className="mt-2 text-xs sm:text-sm text-neutral-400 max-w-2xl font-mono uppercase tracking-wider">
              [THERMAL_MANAGEMENT] // LIQUID AIOs, DUAL-TOWER HEAT SINKS & ULTRA-CONDUCTIVE COMPOUNDS
            </p>
          </div>
        </FadeContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {thermalCategories.map((cat) => (
              <Link
                key={cat.id}
                to={cat.route}
                className="group relative flex flex-col justify-between overflow-hidden rounded-none border-2 border-neutral-700 bg-[#120F17] p-6 hover:border-cyan-400 transition-all duration-200 shadow-[4px_4px_0px_0px_#000000] dark:shadow-[4px_4px_0px_0px_#06B6D4] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#000000] dark:hover:shadow-[6px_6px_0px_0px_#06B6D4] cursor-pointer"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-[11px] font-mono font-bold uppercase tracking-widest text-cyan-400 bg-cyan-950/80 px-2.5 py-1 rounded-none border-2 border-cyan-500 shadow-[2px_2px_0px_0px_#06B6D4]">
                      {cat.badge}
                    </span>
                  </div>

                  <h3 className="text-2xl font-black text-white tracking-tight uppercase group-hover:text-cyan-400 transition-colors font-sans">
                    {cat.title}
                  </h3>
                ...
                <div className="relative z-10 pt-4 border-t-2 border-neutral-800 flex items-center justify-between">
                  <span className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400 group-hover:text-white flex items-center gap-2">
                    EXPLORE {cat.title}
